...
color ();
  ...
  if(message.content == "q1") {
    message.reply("Свежие фрукты содержат 93% воды, а высушенные — 16%. Сколько требуется свежих фруктов для приготовления 21 кг высушенных фруктов?изменено
    Ответ пусть х кг требуется свежих фруктов. Тогда сухая часть в них [полностью без воды] составит 0,07х кг. Сухая часть в 21 кг высушенных фруктов составит 0,8421 кг.");
  }
});
